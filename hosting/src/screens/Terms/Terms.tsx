...
export const TermsContainer = tags.div({})({
  h1: { fontSize: "34px", lineHeight: "38px", marginTop: 8 },
  h2: { fontSize: "24px", lineHeight: "24px", marginTop: 8 },
  h3: { fontSize: "20px", lineHeight: "20px", marginTop: 8 },
  h4: { fontSize: "18px", lineHeight: "20px", marginTop: 8 },
  p: {
    fontSize: "14px",
    lineHeight: "19px",
    small: {
  ...
  return (
    <TermsContainer>
      <Card>
        ...
        <p>
          <small>Last updated: November 16, 2023</small>
        </p>
        <p>
          <small>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to GuildBloom.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to GuildBloom, accessible from{" "}
              <a
                href="https://guildbloom.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://guildbloom.com
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          all of the product's instructions, documents and wrappings. Goods that
        ...
        <ul>
          <li>
            ...
            <br />
            <a
              href="https://guildbloom.com/help"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://guildbloom.com/help
            </a>
          </li>
        </ul>
      </Card>
